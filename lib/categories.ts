...
export const EVENT_CATEGORIES: Category[] = [
  { id: "nightlife", label: "Nachtleben", icon: "moon", gradientStart: "#6C5CE7", gradientEnd: "#8B5CF6" },
  { id: "food_drink", label: "Essen & Trinken", icon: "restaurant", gradientStart: "#FF6B9D", gradientEnd: "#FF8E53" },
